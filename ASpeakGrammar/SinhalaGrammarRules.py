...
N[NUM=sg, GEN=NE, CASE=F1, DEF=TRue]   -> 'සමාජය' | 'වෙලාව' 
N[NUM=sg, GEN=NE, CASE=F1, DEF=False]   -> 'සමාජයක්' | 'වෙලාවක්' 
N[NUM=sg, GEN=NE, CASE=F3, DEF=TRue]   -> 'සමාජයට' | 'වෙලාවට' 
N[NUM=sg, GEN=NE, CASE=F3, DEF=False]   -> 'සමාජයකට' | 'වෙලාවකට' 
N[NUM=sg, GEN=NE, CASE=F4, DEF=TRue]   -> 'සමාජයේ' | 'වෙලාවේ' 
N[NUM=sg, GEN=NE, CASE=F4, DEF=False]   -> 'සමාජයක' | 'වෙලාවක' 
N[NUM=sg, GEN=NE, CASE=F5, DEF=TRue]   -> 'සමාජයෙන්' | 'වෙලාවෙන්' 
N[NUM=sg, GEN=NE, CASE=F5, DEF=False]   -> 'සමාජයකින්' | 'වෙලාවකින්' 
